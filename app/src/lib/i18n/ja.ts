...
export const ja: Messages = {
  ...
  agentPanel: {
    ...
    start: "開始",
    baseLabel: "Base",
    baseTip: "この Issue を切る元のブランチ＝Sync / Merge / PR の向き先。既定はリポの現在ブランチ。リリース前の機能を直すならその機能ブランチを選ぶ。開始すると固定されます。",
    baseRefresh: "ブランチを更新（リモートから取得）",
    baseSearch: "ブランチを検索…",
    baseNoMatch: "一致するブランチなし",
  ...
  share: {
    ...
    tabLink: "リンク",
    tabExport: "エクスポート",
    exportDesc: "選択したページを Markdown / HTML ファイルとして .zip にまとめます。Slack 等にそのまま添付できます。（ライブの Preview / Map は URL 共有のみ）",
    exportZip: ".zip でエクスポート",
    exportEmpty: "エクスポートできるページ（Design の doc / ワイヤー、または QA）を1つ以上選んでください。",
    revealExport: "Finder で表示",
  ...
  session: {
    ...
    prCreatedDraft: "下書き PR を作成して開きました — GitHub で確認して「Ready for review」を押してください。",
    prPrefillBody:
