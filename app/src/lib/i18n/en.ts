...
export const en = {
  ...
  journey: {
    ...
    notifyShareReady: "Your share link is ready.",
    toc: "On this page",
  ...
  settings: {
    ...
    notifications: {
      title: "Notifications",
      desc: "Get a desktop notification when an agent finishes or needs you while Bezier is in the background. Click it to jump back to that issue. Your OS asks for permission the first time.",
  ...
  nextStep: {
    label: "Next step",
    proceed: "Proceed",
    proceedPrompt: "Let's do this next: {suggestion}",
    note: "next step",
    dismiss: "Dismiss",
  },
  mockComment: {
  ...
  agentPanel: {
    ...
    start: "Start",
    baseLabel: "Base",
    baseTip: "The branch this issue is cut from, and that Sync / Merge / PR will target. Default: the repo's current branch. Pick a feature branch to fix an unreleased feature before it ships. Pinned once you start.",
    baseRefresh: "Refresh branches (fetch from remote)",
    baseSearch: "Search branches…",
    baseNoMatch: "No matching branch",
  ...
  share: {
    ...
    tabLink: "Link",
    tabExport: "Export",
    exportDesc: "Bundle the selected pages as Markdown / HTML files in a .zip — drop it straight into Slack, etc. (Live Preview / Map are URL-only.)",
    exportZip: "Export as .zip",
    exportEmpty: "Select at least one exportable page (a Design doc / wireframe, or QA).",
    revealExport: "Show in Finder",
  ...
  session: {
    ...
    notifyPreviewReady: "Preview is ready.",
    notifyPreviewError: "Preview failed to start.",
    notifyPrepared: "This repository is ready.",
    ...
    prCreatedDraft: "Opened a draft PR — review it on GitHub, then click “Ready for review”.",
    prPrefillBody:
      "Generated by Bezier. Review the title/description and the diff, then create the PR.",
  },
};
