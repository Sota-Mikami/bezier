...
export const en = {
  ...
  session: {
    ...
    prPrefillOpened: "Opened GitHub's PR page — review the diff and click Create.",
    prNotGitHub: "This repo's origin isn't a GitHub remote, so the PR page can't be opened.",
    prPrefillBody:
      "Generated by Bezier. The spec, decisions, and QA ride in this PR's diff. Review the diff, then create the PR.",
    prPrefillBodyHandoff:
      "Generated by Bezier. Spec / acceptance / decisions / QA are in `{handoff}` (in this diff). Review the diff, then create the PR.",
  },
};
