...
- **サイズ統一（design-token）**: タブ的役割の3要素を **13px に統一**。`UnderlineTab` ラベル 12→**13px**、Design タブの id バッジ 10→**11px**、Spec ToC 項目 12→**13px**・行間（py-1→py-1.5）。Implement/Design/ToC のサイズ感を揃えた。
